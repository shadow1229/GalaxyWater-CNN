...
import random
from build_fg_lig_gpu import build_data_strict_all,build_gkernel,\
...
if __name__ == '__main__':
    ...
    predict_lig(nets,names,pro_path,out_name, lig_path, n_grid=64, padding=4.0, build_prefixs=names,dbloss=True)
